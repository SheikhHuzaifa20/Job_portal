  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-3 col-sm-12">
        <div class="ft-logo"><img src="{{url("asset/images/logo.png")}}" alt="Your alt text here"></div>
        ...
        <!-- <div class="social"> 
          ...
          <i style="color: white;" class="fa fa-facebook-square" aria-hidden="true"></i>
          </a> 
          <a href="#." target="_blank">
            <i style="color:white;" class="fa fa-twitter-square" aria-hidden="true"></i>
          </a> 
          <a href="#." target="_blank">
            <i style="color:white;" class="fa fa-google-plus-square" aria-hidden="true"></i>
          </a> 
          <a href="#." target="_blank">
              <i style="color:white;" class="fa fa-linkedin-square" aria-hidden="true"></i>
            </a> 
            <a href="#." target="_blank">
              <i style="color:white;" class="fa fa-youtube-square" aria-hidden="true"></i>
            </a> 
          </div> -->
        <!-- Social Icons end -->
      </div>
      ...
      <div class="col-md-4 col-sm-12">
        ...
        <ul class="posts-list">
          ...
          <li>
            <article class="post post-list">
              <div class="entry-content media">
                <div class="media-left"> <a href="#." title="" class="entry-image"> <img width="80" height="80" src="{{url("asset/images/news-1.jpg")}}" alt="Your alt text here"> </a> </div>
          ...
          <li>
            <article class="post post-list">
              <div class="entry-content media">
                <div class="media-left"> <a href="#." title="" class="entry-image"> <img width="80" height="80" src="{{url("asset/images/news-2.jpg")}}" alt="Your alt text here"> </a> </div>
                <div class="media-body">
                  <h4 class="entry-title"> <a href="#.">Sed fermentum at lectus nec porta.</a> </h4>
                  <div class="entry-content-inner">
                    <div class="entry-meta"> <span class="entry-date">Jan 28, 2016</span> </div>
          ...
          <li>
            <article class="post post-list">
              <div class="entry-content media">
                <div class="media-left"> <a href="#." title="" class="entry-image"> <img width="80" height="80" src="{{url("asset/images/news-3.jpg")}}" alt="Your alt text here"> </a> </div>
                <div class="media-body">
                  <h4 class="entry-title"> <a href="#.">Sed fermentum at lectus nec porta.</a> </h4>
                  <div class="entry-content-inner">
                    <div class="entry-meta"> <span class="entry-date">Jan 28, 2016</span> </div>
