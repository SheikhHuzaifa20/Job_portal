...
use App\Http\Controllers\Job_PortalController;
use App\Http\Controllers\HomeController;
use App\Http\Controllers\LoggedInController;
use App\Http\Controllers\Post_jobController;
...
Route::get('orders/{id?}','LoggedInController@orders')->name('orders');
Route::get('reviews','LoggedInController@reviews')->name('reviews');
Route::delete('approval/{id}', 'LoggedInController@approval')->name('approval.delete');
Route::get('/approvaled/{id}', 'LoggedInController@approvaled')->name('approvaled');
...
Route::get('add_product',[Job_PortalController::class, 'add_product'])->name('add_product');
Route::get('view_product', [Job_PortalController::class, 'view_product'])->name('view_product');
Route::post('add_product',[Job_PortalController::class, 'store_product'])->name('add_product.store');
Route::delete('/product/delete/{id}',[Job_PortalController::class, 'product_destroy'])->name('delete_product');
Route::get('/product/edit/{id}',[Job_PortalController::class, 'edit'])->name('edit_product');
Route::post('/product/update/{id}',[Job_PortalController::class, 'update'])->name('update_product');
Route::get('/post_job',[Job_PortalController::class, 'post_job'])->name('post_job');
Route::get( '/jobs', [Job_PortalController::class, 'jobs'])->name( 'jobs');
Route::get('approval', [Post_jobController::class, 'approval'])->name('approval');
Route::post( '/Credentials', [Post_jobController::class, 'Credentials'])->name( 'Credentials');
...
Route::any('/job',[Job_PortalController::class, 'searchJobs'])->name('searchJobs');
